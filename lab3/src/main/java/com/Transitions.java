...
public class Transitions extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        ft.setFromValue(1.0); // встановлення початкового значення прозорості
		// об'єкту
        ft.setToValue(0.1); // встановлення кінцевого значення прозорості
		// об'єкту
        ...
        path.getElements()
                .add(new MoveTo(20,
                        20)); // вказання початкової позиції, з якої
		// починається траекторія
        path.getElements()
                .add(new CubicCurveTo(380,
                        0,
                        380,
                        120,
                        200,
        ...
        pathTransition.setDuration(Duration.millis(4000)); // встановлення
		// часу анмації
